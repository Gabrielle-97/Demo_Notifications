package sg.edu.rp.c346.id19020303.demonotifications;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify1 = findViewById(R.id.btnNot1);
        btnNotify2 = findViewById(R.id.btnNot2);
        ...
        btnNotify1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NotificationManager notificationManager = (NotificationManager)
                    ...
                    //An integer goof to have, for you programmatically cancel it
